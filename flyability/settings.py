...
# supposedly this turns on timezone aware datetime objects
USE_TZ = True
...
STATIC_ROOT = '/var/www/flyability.org/static/'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/var/django/flyability/templates'
)
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file':{
            ...
            'formatter': 'normal',
            'filename': '/var/log/django/flyability.log' 
        },
    },
    'loggers': {
        'django.request': {
