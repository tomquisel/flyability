...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('weather_forecast', ['site_id', 'fetch_time'])
        db.create_index('weather_observation', ['site_id', 'fetch_time'])

    def backwards(self, orm):
        db.delete_index('weather_forecast', ['site_id', 'fetch_time'])
        db.delete_index('weather_observation', ['site_id', 'fetch_time'])
