...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('weather_forecast', 'fetchTime', 'fetch_time')
        db.rename_column('weather_observation', 'fetchTime', 'fetch_time')


    def backwards(self, orm):
        db.rename_column('weather_forecast', 'fetch_time', 'fetchTime')
        db.rename_column('weather_observation', 'fetch_time', 'fetchTime')
